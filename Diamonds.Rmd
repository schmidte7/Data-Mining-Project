...
acc_1_1 <- accuracy(object = y_valid_pred, x = y_valid_real)
acc_1_1

```

### NN (Layers = 1, Nodes = 26)
...
# copmuting accuracy measures of validation set
acc_1_26 <- accuracy(object = y_valid_pred_1_26, x = y_valid_real)
acc_1_26
```

### NN (Layers = 1, Nodes = 13)
...
# copmuting accuracy measures of validation set
acc_1_13 <- accuracy(object = y_valid_pred_1_13, x = y_valid_real)
acc_1_13
```

### NN (Layers = 2, Nodes = 26)
...
# copmuting accuracy measures of validation set
acc_2_26 <- accuracy(object = y_valid_pred_2_26, x = y_valid_real)
acc_2_26
```
...
### NN with Initializer (Layers = 2, Nodes = 26, GlorotNormal)
...
# copmuting accuracy measures of validation set
acc_2_26G <- accuracy(object = y_valid_pred_2_26G, x = y_valid_real)
acc_2_26G
```



### NN with Initializer and Learning Rate (Layers = 2, Nodes = 26, GlorotNormal, LR = 0.005)
...
# copmuting accuracy measures of validation set
acc_2_26GLR <- accuracy(object = y_valid_pred_2_26GLR, x = y_valid_real)
acc_2_26GLR
```
