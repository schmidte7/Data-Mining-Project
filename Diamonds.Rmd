...
#### Analysis
Throughout this entire section, typically the lower RMSE produced the best model. In random forests though, we proposed a trade-off with picking a model with less trees because an analyst would want to choose the parsimonious  model. Therefore, the random forest with 60 trees had a slightly higher RMSE at a difference of approximately $2 which was $577.63.
