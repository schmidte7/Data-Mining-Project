...
plot(diamonds$depth_ratio,diamonds$price, col = "#D8B365", main = "Distribution of Depth Ratio on Price", xlab = "Depth Ratio", ylab= "Price")
```
...
Accs <- Accs[, c(6, 1:5)]
kable_styling(kable(Accs)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(kNN_aa1)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(opt_accuracy)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(tree_aa1)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(tree_aa2)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(tree_aa3)%>% kable_classic(), full_width = FALSE) 
```
...
kable_styling(kable(tree_aa4)%>% kable_classic(), full_width = FALSE) 
```
...
kable_styling(kable(tree_aa5)%>% kable_classic(), full_width = FALSE)  
```
...
kable_styling(kable(tree_aa6)%>% kable_classic(), full_width = FALSE) 
```
...
kable_styling(kable(tree_aa7)%>% kable_classic(), full_width = FALSE) 
```
...
kable_styling(kable(tree_aa8)%>% kable_classic(), full_width = FALSE) 
```
...
kable_styling(kable(Tree_res)%>% kable_classic(), full_width = FALSE)


RGRMSEplotdata <- t(Tree_res$RMSE)
colnames(RGRMSEplotdata) <- t(rownames(Tree_res))
barplot(RGRMSEplotdata, col = "#D8B365")
...
kable_styling(kable(acc_1)%>% kable_classic(), full_width = FALSE)
...
kable_styling(kable(acc_2)%>% kable_classic(), full_width = FALSE)
...
kable_styling(kable(acc_3)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(acc_4)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(acc_5)%>% kable_classic(), full_width = FALSE)
```
...
kable_styling(kable(acc_6)%>% kable_classic(), full_width = FALSE)
```
...
barplot(NNRMSEplotdata, col = "#D8B365")
...
kable_styling(kable(ens_error)%>% kable_classic(), full_width = FALSE)
