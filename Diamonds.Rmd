...
```{r dummies-and-dummies-minus-corr, eval=FALSE, include=FALSE}
...
```{r iterative-search-dummies, eval=FALSE, include=FALSE}
...
```{r iterative-search-dummies-minus-corr, eval=FALSE, include=FALSE}
...
# library(olsrr)
# 
# ols_step_best_subset(LM_backward_dummies)
# A = regsubsets(price ~. , data = TrainD, method = "exhaustive")
# A
# B = summary(A)
# B$which
```
