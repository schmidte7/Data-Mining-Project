...
```{r ggpairs, eval=FALSE, fig.height=, fig.width=6, include=FALSE}
...
```{r Price by X and Clarity, fig.width = 6, fig.height = 6,include = TRUE, echo = FALSE}
...
```{r Price by X and Color, fig.width = 6, fig.height = 6, include = TRUE, echo = FALSE}
# Create plot that looks at carat and price
...
```{r Price by X and Cut, fig.width = 6, fig.height = 6, include = TRUE, echo = FALSE}
# Create plot that looks at carat and price
...
```{r categorical bar plots, fig.height=2.5, fig.width=4}
...
```{r Histograms, include = TRUE, echo = FALSE}
...
```{r Ensemble Summary Plot, fig.height= 5, fig.width = 5, dpi= 150}
...
```{r Summ Color Plots, include = TRUE, echo = FALSE}
...
```{r Summ Cut Plots, include = TRUE, echo = FALSE}
