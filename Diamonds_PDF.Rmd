...
kable_classic(kable(sapply(Train_lr[, c(1, 5:10)], skewness), col.names = "$b_{1}$",
      caption = "Skewness estimator for numerical variables", escape = FALSE),
...
kable_classic(kable(Accs, caption = "Accuracy measures of linear models"), latex_options = "hold_position", full_width = TRUE)
```
...
column_spec(kable_classic(kable(t(round(accuracy_df, digits = 2))),
                          full_width = TRUE, latex_options = c("hold_position", "scale_down")),
...
kable_styling(kable(Tree_res)%>% kable_classic(), full_width = TRUE, latex_options = "hold_position")
...
kable_styling(kable(NN_res)%>% kable_classic(), full_width = TRUE, latex_options = "hold_position")
...
row.names(ens_rmse_summ) <- c("Multiple Linear Regression",
                              ...
                              "Ensemble")
#display results
kable_styling(kable(ens_rmse_summ)%>% kable_classic(),
              full_width = TRUE, latex_options = "hold_position")
```
