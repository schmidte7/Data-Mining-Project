...
column_spec(kable_classic(kable(round(t(accuracy_df), digits = 2), col.names = NULL),
                          latex_options = c("hold_position", "scale_down")),
...
kable_styling(kable(knn_res)%>% kable_classic(), full_width = TRUE, latex_options = "hold_position")
```
