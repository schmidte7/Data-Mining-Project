...
titlepage: true
titlepage-rule-color: "D8B365"
titlepage-text-color: "D8B365"
...
knitr::opts_chunk$set(message = FALSE, warning = FALSE, fig.align = "center", include = FALSE, dev = "png", cache = TRUE, dpi = 150, fig.pos = "H", out.extra = "")
```
...
```{r threshold diff hist, include = TRUE, echo = FALSE, out.width="0.5\\linewidth", fig.cap="Amount of records by difference between computed depth ratio and actual depth ratio"}
...
3. The depth_ratio is a calculation between `length` (`x`), `width` (`y`), and `depth` (`z`). To investigate this feature further, our group computed `depth_ratio` and saw there were differences between the actual and predicted values. As seen in **Figure 1**, most errors were at 0.2, hence the executive decision was to remove any differences above a threshold of 0.3. A total of 253 rows were removed.  
...
ggpairs(diamonds[, c(1, 5:10)], title = "Scatter plot Matrix",
         proportions = "auto",
...
```{r Price by X and Clarity, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Price with respect to numerical variables, by Clarity"}
# Create plot that looks at carat and price
PCl1 <- ggplot(aes(x = carat, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1,aes(color=clarity)) +
...
PCl2 <- ggplot(aes(x = length, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=clarity)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Clarity', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at width and price
PCl3 <- ggplot(aes(x = width, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=clarity)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Clarity', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at depth and price
PCl4 <- ggplot(aes(x = depth, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=clarity)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Clarity', reverse = T,override.aes = list(alpha = 1, size = 2)))  + theme_classic()

# Create plot that looks at depth_ratio and price
PCl5 <- ggplot(aes(x = depth_ratio, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=clarity))  + scale_color_brewer(type = 'div', guide = guide_legend(title = 'Clarity', reverse = T,override.aes = list(alpha = 1, size = 2)))  + theme_classic() + geom_vline(xintercept=mean(diamonds$depth_ratio), size = 1, color = "black") + geom_vline(xintercept=59, size = 1, color = "red") + geom_vline(xintercept=62.3, size = 1, color = "red")

# Create plot that looks at table and price
PCl6 <- ggplot(aes(x = table, y = price), data = diamonds) +  geom_point(alpha = 0.5, size = 1, aes(color=clarity))  + scale_color_brewer(type = 'div', guide = guide_legend(title = 'Clarity', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic() + geom_vline(xintercept=mean(diamonds$table), size = 1, color = "black") 

# Arrange ggplots into one frame
ggarrange(PCl1, PCl2, PCl3,PCl4, PCl5, PCl6, ncol = 2, nrow = 3, common.legend = TRUE, legend="right")
```
...
```{r Price by X and Color, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Price with respect to numerical variables, by Color"}
# Create plot that looks at carat and price
PCo1 <- ggplot(aes(x = carat, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=color)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Color', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at length and price
PCo2 <- ggplot(aes(x = length, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=color)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Color', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at width and price
PCo3 <- ggplot(aes(x = width, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=color)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Color', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at depth and price
PCo4 <- ggplot(aes(x = depth, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=color)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Color', reverse = T,override.aes = list(alpha = 1, size = 2)))   + theme_classic()

# Create plot that looks at depth_ratio and price
PCo5 <- ggplot(aes(x = depth_ratio, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=color))  + scale_color_brewer(type = 'div', guide = guide_legend(title = 'Color', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic() + geom_vline(xintercept=mean(diamonds$depth_ratio), size = 1, color = "black")  + geom_vline(xintercept=59, size = 1, color = "red") + geom_vline(xintercept=62.3, size = 1, color = "red")

# Create plot that looks at table and price
PCo6 <- ggplot(aes(x = table, y = price), data = diamonds) +  geom_point(alpha = 0.5, size = 1, aes(color=color))  + scale_color_brewer(type = 'div', guide = guide_legend(title = 'Color', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic() + geom_vline(xintercept=mean(diamonds$table), size = 1, color = "black")
...
A similar relationship can be seen regarding `price` by the continuous variables, but as `color` as the color dimension. Instead of a majority the observations falling closer to the best and worst `clarity` features, here the reader will notice how it appears that the colors E, F and G dominate (the white to light blue) the space. 

```{r Price by X and Cut, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Price with respect to numerical variables, by Cut"}
# Create plot that looks at carat and price
PCu1 <- ggplot(aes(x = carat, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=cut)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Cut', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at length and price
PCu2 <- ggplot(aes(x = length, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=cut)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Cut', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at width and price
PCu3 <- ggplot(aes(x = width, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=cut)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Cut', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at depth and price
PCu4 <- ggplot(aes(x = depth, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=cut)) +
  scale_color_brewer(type = 'div', guide = guide_legend(title = 'Cut', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic()

# Create plot that looks at depth_ratio and price
PCu5 <- ggplot(aes(x = depth_ratio, y = price), data = diamonds) + geom_point(alpha = 0.5, size = 1, aes(color=cut))  + scale_color_brewer(type = 'div', guide = guide_legend(title = 'Cut', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic() + geom_vline(xintercept=mean(diamonds$depth_ratio), size = 1, color = "black") + geom_vline(xintercept=59, size = 1, color = "red") + geom_vline(xintercept=62.3, size = 1, color = "red")

# Create plot that looks at table and price
PCu6 <- ggplot(aes(x = table, y = price), data = diamonds) +  geom_point(alpha = 0.5, size = 1, aes(color=cut))  + scale_color_brewer(type = 'div', guide = guide_legend(title = 'Cut', reverse = T,override.aes = list(alpha = 1, size = 2))) + theme_classic() + geom_vline(xintercept=mean(diamonds$table), size = 1, color = "black")
...
```{r categorical bar plots, include=TRUE, echo=FALSE, fig.height=3, out.width="\\linewidth", fig.cap="Bar plots of categorical variables"}
ggplot(gather(data = diamonds[, c(2:4)]), aes(ordered(value, levels =
                                                        c("I1", "SI2", "SI1", "VS2", "VS1",
                                                          "VVS2", "VVS1", "IF",
                                                          "J", "I", "H", "G", "F", "E", "D",
                                                          "Fair", "Good", "Very Good",
                                                          "Premium", "Ideal")))) +
  geom_bar(width = 0.5, color = "#D8B365", fill = "#D8B365") +
  facet_wrap(~key, scales = "free") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  labs(title = "Bar plots of categorical variables", x = "Value", y = "Count")
...
```{r Histograms, include = TRUE, echo = FALSE, dpi = 150, fig.height=2.5, out.width="\\linewidth", fig.cap="Histograms of numerical variables"}
ggplot(gather(data = diamonds[, c(1, 5:10)]), aes(value)) +
  ...
  facet_wrap(~ key, scales = "free", nrow = 2) + # Converting the graphs into panels
...
```{r Correlation, include = TRUE, echo = FALSE, out.width="0.5\\linewidth", fig.cap="Correlation heatmap of numerical variables"}
...
```{r uncorrelated-ellipses, include=TRUE, echo=FALSE, out.width="0.4\\linewidth", fig.cap="Correlation ellipses for numerical variables"}
...
```{r hist-unskewed, include=TRUE, echo=FALSE,fig.height=3, out.width="\\linewidth", fig.cap="Histograms of numerical variables after unskewing"}
...
ggplot(gather(data = Train_lr[, c(1, 5:10)]), aes(value)) + # numerical vars of training set
  ...
  facet_wrap(~ key, scales = "free", nrow = 2) +            # multiple plots with facet
...
column_spec(kable_classic(kable(round(t(accuracy_df), digits = 2),
                                caption = "RMSE value with respect to k"),
                          latex_options = c("hold_position", "scale_down")),
            5, bold = T, color = "white", background = "#D8B365")
```
...
knn_res = list(as.data.table(knn_aa1), as.data.table(knn_aa2))
knn_res = rbindlist(knn_res)
knn_res[, Model_kNN := c("k = 1", "k = 4")]
knn_res <- knn_res[, c(6, 1:5)]
...
kable_styling(kable(knn_res, caption = "Accuracy measures of models with k = 1 and k = 4") %>%
...
KNNcomp <- ggplot(data = knn_res, aes(x = rownames(knn_res), y = RMSE))+
  geom_bar(stat = "identity", fill = "#D8B365", width = 0.3)+
  theme_classic()+
...
```{r knn double plot, include = TRUE, echo = FALSE, out.width="0.5\\linewidth", fig.width=10, fig.cap="Evolution of RMSE with respect to k and difference of RMSE for k = 1 and k = 4"}
...
```{r Default Regression Tree, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Regression tree diagram"}
...
```{r  RF Variable Importance, include = TRUE, echo = FALSE, out.width="0.5\\linewidth", fig.cap="Variable importance for random forest"}
options(scipen = 9999)

# Create variable importance chart
vip::vip(rdf_model, aesthetics = list(fill = "#D8B365")) +
  ggtitle("Random Forest Variable Importance") + # Title name
  xlab("Variable") + # Label names
  theme_classic() +
  theme(axis.text.x = element_text(vjust = 1, size = 8, hjust = 1), text = element_text(size = 10))
```
...
```{r RegTree Summary, include = TRUE, echo = FALSE, out.width="0.5\\linewidth", fig.cap="RMSE of decision trees"}
...
kable_styling(kable(Tree_res[,2:6], caption = "Accuracy measures of decision tree models") %>%
                kable_classic(), full_width = TRUE, latex_options = "hold_position")


RGTreecomp <- ggplot(data = Tree_res, aes(x = Model_Tree, y = as.numeric(RMSE)))+
  geom_bar(stat = "identity", fill = "#D8B365")+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, size = 8, hjust = 1), text = element_text(size = 10))+
  ggtitle("Decision Tree Comparison")
...
```{r NN Summary, include = TRUE, echo = FALSE, out.width="0.5\\linewidth", fig.cap="RMSE of neural networks"}
...
kable_styling(kable(NN_res, caption = "Accuracy measures of neural network models") %>%
                kable_classic(), full_width = TRUE, latex_options = "hold_position")



NNcomp <- ggplot(data = NN_res, aes(x = ordered(rownames(NN_res), levels =
                                                  c("L1 N1", "L1 N26", "L1 N13", "L2 N26",
                                                    "L2 N26 G", "L2 N26 G LR")),
                                    y = as.numeric(RMSE))) +
  geom_col(fill = "#D8B365")+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, size = 8, hjust = 1),
        text = element_text(size = 10)) +
  labs(title = "Neural Network Comparison", x = "Neural network model", y = "RMSE")
...
![Visual description of Neural Network](NN_res.jpeg)
...
row.names(ens_rmse_summ) <- c("Multiple Linear Regression",
                              ...
                              "Ensemble")
#display results
kable_styling(kable(ens_rmse_summ, caption = "Accuracy measures of five main models") %>%
                kable_classic(), full_width = TRUE, latex_options = "hold_position")
```
...
```{r Ensemble Summary Plot, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Predicted Price vs Real Price by Clarity"}
...
```{r Summ Color Plots, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Predicted Price vs Real Price by Color"}
...
```{r Summ Cut Plots, include = TRUE, echo = FALSE, out.width="\\linewidth", fig.cap="Predicted Price vs Real Price by Cut"}
