...
```{r Missing Values, include=TRUE, echo=FALSE}
...
```{r Variables check hist, include=TRUE, echo=FALSE}
...
```{r ggpairs, echo=FALSE, include=TRUE}
...
```{r Price by X and Clarity, echo=FALSE, include=TRUE}
...
```{r Price by X and Color, eval=FALSE, include=FALSE}
# Create plot that looks at carat and price
...
```{r Price by X and Cut, eval=FALSE, include=FALSE}
# Create plot that looks at carat and price
