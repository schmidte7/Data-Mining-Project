...
knitr::opts_chunk$set(message = FALSE, warning = FALSE, fig.align = "center", include=FALSE,
                      dev = "png", cache = FALSE, sanitize = TRUE)
...
kable_classic(kbl(knn_res), full_width = TRUE, latex_options = "hold_position")
```

```{r, include=TRUE, echo=FALSE}
row_spec(kable_classic(kbl(A), full_width = FALSE, latex_options = "scale_down"), row = 2, bold = T, color = "#D8B365", background = "white")
```
